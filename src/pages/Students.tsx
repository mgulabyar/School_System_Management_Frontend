          ...
          <>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Typography
                    sx={{ fontSize: "0.65rem", opacity: 0.85, mt: 0.5 }}
                  >
                ...
                <Box sx={{ px: 3, pb: 3, textAlign: "center" }}>
                  ...
                  >
                    Class: {selectedStudent.class.name} | Roll No:{" "}
                    {selectedStudent.rollNo}
                  </Typography>
                  <Divider
                    sx={{ my: 1.5, borderColor: "divider", opacity: 0.6 }}
            ...
            >
              <Button
                ...
                variant="text"
                color="primary"
                sx={{ height: 38, fontSize: "13px", textTransform: "none" }}
              >
                Cancel
              </Button>
              <Button
            ...
            <DialogContent sx={{ p: 3, pt: "24px !important" }}>
              ...
              >
                ...
                >
                  ...
                  <strong>{selectedStudent.user.name}</strong>, child of{" "}
                  <strong>{selectedStudent.parentName}</strong>, bearing
                  Admission Number{" "}
                  <strong>{selectedStudent.admissionNo}</strong>, has
                  successfully completed their studies in Class{" "}
                  <strong>{selectedStudent.class.name}</strong>. Their conduct
                  and character during their tenure at this institution have
                  been exemplary. All outstanding school dues have been cleared.
                </Typography>
                <Box
                  sx={{
                    display: "flex",
